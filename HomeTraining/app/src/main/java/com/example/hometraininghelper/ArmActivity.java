...
public class ArmActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn_easy_body = findViewById(R.id.basic_body); // 팔 초급
        ...
        btn_easy_in=findViewById(R.id.basic_in);

        btn_easy_in.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent=new Intent(getApplicationContext(),ArmEasyInActivity.class);
                startActivity(intent);
            }
        });
