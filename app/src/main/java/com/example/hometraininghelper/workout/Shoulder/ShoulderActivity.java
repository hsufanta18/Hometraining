package com.example.hometraininghelper.workout.Shoulder;
...
public class ShoulderActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn_easy_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ShoulderEasyInstrumentActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_normal_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ShoulderNorInstrumentActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_hard_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ShoulderHardInstrumentActivity.class);
                startActivity(intent);
            }
        });
    }
