package com.example.hometraininghelper.workout.Abs;
...
import com.example.hometraininghelper.workout.Chest.ChestActivity;
...
public class AbsActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_easy_body = findViewById(R.id.easy_body); // 복근 초급
        ...
        btn_normal_body = findViewById(R.id.normal_body); // 복근 초급
        ...
        btn_normal_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), AbsNorInstrumentActivity.class);
                startActivity(intent);
            }
        });

        btn_hard_body = findViewById(R.id.hard_body); // 복근 초급
        ...
        btn_hard_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), AbsHardInstrumentActivity.class);
                startActivity(intent);
            }
        });
    }
