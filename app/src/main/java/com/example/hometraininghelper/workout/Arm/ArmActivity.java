package com.example.hometraininghelper.workout.Arm;
...
public class ArmActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn_easy_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ArmEasyInstrumentActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_normal_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ArmNorInstrumentActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_hard_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ArmHardInstrumentActivity.class);
                startActivity(intent);
            }
        });
    }
