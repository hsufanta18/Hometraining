package com.example.hometraininghelper.workout.Leg;
...
public class LegActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn_easy_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegEasyInstrumentActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_normal_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegNorInstrumentActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_hard_instrument.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegHardInstrumentActivity.class);
                startActivity(intent);
            }
        });
    }
